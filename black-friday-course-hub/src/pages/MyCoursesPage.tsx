...
import { subscriptionsAPI } from "@/data/mockData";
...
const MyCoursesPage = () => {
  ...
  useEffect(() => {
    const fetchMyCourses = async () => {
      try {
        setLoading(true);
        const courses = await subscriptionsAPI.getMyCourses();
        setEnrolledCourses(courses);
        console.log('✅ My courses loaded:', courses.length);
      } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {loading ? (
          <div className="text-center text-muted-foreground">Loading your courses...</div>
